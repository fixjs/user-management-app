...
const host = process.env.WEBSITE_HOSTNAME || defaultHostName;
...
const GROUPS_API_PATH = `${__WEBPACK_IMPORTED_MODULE_0__config__["d" /* protocol */]}://${__WEBPACK_IMPORTED_MODULE_0__config__["e" /* host */]}/apis/groups`;
/* harmony export (immutable) */ __webpack_exports__["a"] = GROUPS_API_PATH;

const USERS_API_PATH = `${__WEBPACK_IMPORTED_MODULE_0__config__["d" /* protocol */]}://${__WEBPACK_IMPORTED_MODULE_0__config__["e" /* host */]}/apis/users`;
